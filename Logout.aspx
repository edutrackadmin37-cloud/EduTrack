<%@ Page Title="Logout - EduTrack" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Logout.aspx.cs" Inherits="EduTrack.Auth.Logout" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <style>
        ...
        .btn-auth { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none; border-radius: 12px; padding: 0.85rem 2rem; font-weight: 700; color: #fff; }
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <h2>Logout</h2>
                <p>Are you sure you want to log out of EduTrack?</p>
            </div>
            <div class="auth-body">
                <asp:Label ID="lblMessage" runat="server" CssClass="alert d-block" Visible="false" />

                <div class="d-flex gap-3 justify-content-center flex-wrap">
                    <asp:Button ID="btnConfirmLogout" runat="server" Text="Yes, Logout" CssClass="btn-auth" OnClick="btnConfirmLogout_Click" />
                    <asp:HyperLink ID="hlCancel" runat="server" CssClass="btn-auth btn-secondary" NavigateUrl="~/Default.aspx">Cancel</asp:HyperLink>
                </div>
            </div>
        </div>
    </div>
